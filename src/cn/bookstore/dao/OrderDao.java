...
public class OrderDao extends BaseDao {
	 ...
	 * @throws SQLException
	 */
	public PageBean<Order> findByUser(String uid, int pc) throws Exception {
	...
	private PageBean<Order> findByCriteria(List<Expression> exprList, int pc) throws Exception {
		/*
		 * 1. 得到ps
		 * 2. 得到tr
		 * 3. 得到beanList
